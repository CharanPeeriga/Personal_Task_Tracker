...
const TETRIS_PIECES = [
  { shape: [[1, 1, 1, 1]],             color: 'bg-black dark:bg-white' }, // I
  { shape: [[1, 1], [1, 1]],           color: 'bg-black dark:bg-white' }, // O
  { shape: [[0, 1, 0], [1, 1, 1]],    color: 'bg-black dark:bg-white' }, // T
  { shape: [[1, 0], [1, 0], [1, 1]],  color: 'bg-black dark:bg-white' }, // L
  { shape: [[0, 1, 1], [1, 1, 0]],    color: 'bg-black dark:bg-white' }, // S
  { shape: [[1, 1, 0], [0, 1, 1]],    color: 'bg-black dark:bg-white' }, // Z
  { shape: [[0, 1], [0, 1], [1, 1]],  color: 'bg-black dark:bg-white' }, // J
]
      ...
      if (timestamp - lastUpdateRef.current >= fallSpeed) {
        ...
        if (!isClearing && !checkAndReset()) {
          setFallingPiece(prevPiece => {
            ...
            if (canPlacePiece(prevPiece, prevPiece.x, newY)) return { ...prevPiece, y: newY }
